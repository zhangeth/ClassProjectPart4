...
sources = $(wildcard $(SOURCEDIR)/**/StatusCode.java $(SOURCEDIR)/**/models/AttributeType.java $(SOURCEDIR)/**/models/AlgebraicOperator.java $(SOURCEDIR)/**/models/AssignmentExpression.java $(SOURCEDIR)/**/models/AssignmentOperator.java $(SOURCEDIR)/**/models/ComparisonOperator.java $(SOURCEDIR)/**/models/ComparisonPredicate.java $(SOURCEDIR)/**/models/IndexRecord.java $(SOURCEDIR)/**/models/IndexType.java $(SOURCEDIR)/**/models/NonClusteredBPTreeIndexRecord.java $(SOURCEDIR)/**/models/NonClusteredHashIndexRecord.java $(SOURCEDIR)/**/models/Record.java $(SOURCEDIR)/**/models/TableMetaData.java $(SOURCEDIR)/**/RelationalAlgebraOperators.java $(SOURCEDIR)/**/RelationalAlgebraOperatorsImpl.java $(SOURCEDIR)/**/TableManager.java $(SOURCEDIR)/**/TableManagerImpl.java $(SOURCEDIR)/**/Cursor.java $(SOURCEDIR)/**/Indexes.java $(SOURCEDIR)/**/IndexesImpl.java $(SOURCEDIR)/**/IndexesTransformer.java $(SOURCEDIR)/**/Records.java $(SOURCEDIR)/**/RecordsImpl.java $(SOURCEDIR)/**/test/*.java)
